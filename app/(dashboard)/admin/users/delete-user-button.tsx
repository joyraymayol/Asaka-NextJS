...
export function DeleteUserButton({
  ...
  id: number;
  name: string;
  /** Controlled mode -- see UserFormDialog for the same pattern/rationale. */
  open?: boolean;
  ...
  // Two-step confirmation, per user request ("just to be double sure"): see
  // devices/delete-device-button.tsx for the full rationale -- same pattern.
